...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const riceContainer = document.getElementById("rice-menu");

    if (!riceContainer) {
        console.error("Rice menu container not found on page. Check your HTML.");
        return;
    }

    // Fallback data in case JSON loading fails
    const fallbackRiceData = [
        {
            name: "Steamed Rice",
            price: 100,
            description: "Perfectly steamed white rice.",
            image: "../images/rice/steamed-rice.jpg",
            rating: 4.2,
            veg: true
        },
        {
            ...
            price: 140,
            description: "Rice stir-fried with mixed vegetables and spices.",
            image: "../images/rice/veg-fried-rice.jpg",
            rating: 4.5,
            veg: true
        },
        {
        ...
        },
        {
            ...
            price: 170,
            description: "Rice stir-fried with tender chicken pieces and vegetables.",
            image: "../images/rice/chicken-fried-rice.jpg",
            rating: 4.7,
            veg: false
        },
        {
            name: "Jeera Rice",
            price: 120,
            description: "Aromatic rice cooked with cumin seeds.",
    ...
    fetch("../json/rice.json")
        ...
        .catch(error => {
            console.error("Error fetching rice.json:", error);
            // Use fallback data if fetch fails
            console.log("Using fallback rice data");
            populateRiceMenu(fallbackRiceData);
...
function findRelatedDishes(isVeg, currentDishName) {
    const relatedDishes = [];
    const allDishes = document.querySelectorAll('#rice-menu .dish');
